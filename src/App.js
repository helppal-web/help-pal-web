...
class App extends React.Component {
        ...
        render() {
                return ( <
                        ...
                        Route exact path = '/'
                        render = {
                            () => < Redirect to = { APP_PATHS.app }
                            />} / >
                            <
                            AppLayout exact path = { APP_PATHS.app }
                            component = { Main }
                            /> <
                            AppLayout exact path = { APP_PATHS.profile }
                            component = { Profile }
                            /> <
                            AppLayout exact path = { APP_PATHS.notifications }
                            component = { Notifications }
                            /> <
                            Route exact path = { APP_PATHS.login }
                            render = {
                                () => < Logister logister = { 'login' }
                                />} / >
                                <
                                Route exact path = { APP_PATHS.register }
                                render = {
                                    () => < Logister logister = { 'register' }
                                    />} / >
                                    <
                                    /Switch> < /
                                    Router > <
